...
double Utils::meanOfArea(const Mat& imageGray, const Mat& maskAsphalt) {
	Scalar mean, stddev;
...
void Utils::draw_rectangle_on_image(Mat& image, shapes::Rect rect, Scalar color, int width = 2) {
...
void Utils::drawOnRectangles(Mat& image, int start, int diff) {
